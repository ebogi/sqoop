...
public class S3TestUtils {
    ...
    private static String targetDirName = "testdir";
    ...
    public static String getPropertyBucketUrl() {
        return System.getProperty(PROPERTY_BUCKET_URL);
    }

    public static String getTemporaryCredentialsProviderClass() {
    ...
    public static void setTargetDirName(String targetDir) {
        targetDirName = targetDir;
    }

    public static Path getTargetDirPath() {
        String outputPathString = getPropertyBucketUrl() + BUCKET_TEMP_DIR + getTargetDirName();
        return new Path(outputPathString);
    }

    public static void setupS3ImportTestCase(S3CredentialGenerator s3CredentialGenerator,
                                             FileSystem s3Client,
        ...
        clearOutputDir(s3Client);
    }

    public static void setS3CredentialsInHadoopConf(Configuration hadoopConf,
    ...
    public static FileSystem setS3CredentialsInHadoopConfAndGetS3Client(S3CredentialGenerator s3CredentialGenerator) throws IOException {
        Configuration hadoopConf = new Configuration();
        S3TestUtils.setS3CredentialsInHadoopConf(hadoopConf, s3CredentialGenerator);
    ...
    public static void clearOutputDir(FileSystem s3Client) throws IOException{
