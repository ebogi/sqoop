...
public class DefaultS3CredentialGenerator extends S3CredentialGenerator {
    ...
    @Override
    /**
     * Executes the given command under /bin/sh and reads S3 credentials from the first line of standard output
     * in the following order: access key, secret key and session token (the latter one only in case of
